...
function StructuralMember({ position, args, rotation = [0, 0, 0] }: StructuralMemberProps) {
  return (
...
export default function GableRoof({ hoveredId, onHover, onBeamClick }: GableRoofProps) {
